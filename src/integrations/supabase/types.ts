  ...
  public: {
    Tables: {
      ...
      opportunity_document_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "opportunity_document_links_opportunity_id_fkey"
            columns: ["opportunity_id"]
            isOneToOne: false
            referencedRelation: "opportunities"
            referencedColumns: ["id"]
      ...
      opportunity_tasks: {
        ...
        Relationships: [
          {
            foreignKeyName: "opportunity_tasks_assigned_to_fkey"
            columns: ["assigned_to"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      opportunity_work_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "opportunity_work_sessions_logged_by_fkey"
            columns: ["logged_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "opportunity_work_sessions_opportunity_id_fkey"
            columns: ["opportunity_id"]
            isOneToOne: false
            referencedRelation: "opportunities"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "opportunity_work_sessions_task_id_fkey"
            columns: ["task_id"]
            isOneToOne: false
